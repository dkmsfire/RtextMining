...
\section{Trials}
Before using methods that I metioned above, I construct two indexs, (1) without stemming, and (2) with stemming. In each index, I used all of methods above, so there will be 2 \times 4 runs.
