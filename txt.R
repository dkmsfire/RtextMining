...
par(mfrow = c(2,1))
for(i in 1:6){
  png(filename = paste0("model", i, ".png"), width = 400, height = 350)
  par(mfrow = c(2,1))
...
png(filename = "stemming pr.png", width = 400, height = 350)
...
png(filename = "stemming doc.png", width = 400, height = 350)
...
png(filename = "no stemming pr.png", width = 400, height = 350)
...
png(filename = "no stemming doc.png", width = 400, height = 350)
